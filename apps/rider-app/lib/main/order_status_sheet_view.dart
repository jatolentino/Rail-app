...
import 'package:client_shared/components/rail_sheet_view.dart';
import 'package:client_shared/components/rounded_button.dart';
import 'package:client_shared/components/sheet_title_view.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';
import 'package:rail/main/enter_coupon_code_sheet_view.dart';
import 'package:rail/main/enter_gift_code_sheet_view.dart';
import 'package:rail/main/pay_for_ride_sheet_view.dart';
import 'package:rail/main/ride_options_sheet_view.dart';
import 'package:rail/main/ride_safety_sheet_view.dart';
import 'package:rail/main/wait_time_sheet_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Subscription(
        ...
        builder: (QueryResult result) {
          ...
          return railSheetView(child: BlocBuilder<MainBloc, MainBlocState>(
