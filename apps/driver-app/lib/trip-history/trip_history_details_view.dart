...
import 'package:rail/query_result_view.dart';
import 'package:client_shared/theme/theme.dart';
import 'package:rail/trip-history/submit_complaint_view.dart';
...
class TripHistoryDetailsView extends StatelessWidget {
  ...
  const TripHistoryDetailsView({required this.orderId, Key? key})
      : super(key: key);
