...
import { Authorize, BeforeFindOne, FindOneArgsType, IDField, Relation, UnPagedRelation } from "@nestjs-query/query-graphql";
...
import { RiderDocumentType } from "@rail/database/enums/rider-document-type";
...
@UnPagedRelation('coupons', () => CouponDTO, { disableRemove: true, disableUpdate: true })
@UnPagedRelation('orders', () => OrderDTO, { disableRemove: true, disableUpdate: true, maxResultsSize: 1, defaultFilter: {status: {in: [
...
]}}, defaultSort: [{field: 'id', direction: SortDirection.DESC}], defaultResultSize: 1, enableAggregate: true})
